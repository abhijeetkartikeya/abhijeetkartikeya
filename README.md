...
<!-- SOCIAL BADGES -->
<a href="https://www.linkedin.com/in/abhijeet-kartikeya-4626531ba">
...
<img src="https://komarev.com/ghpvc/?username=abhijeetkartikeya&style=for-the-badge&color=0d1117&labelColor=161b22&label=PROFILE+VIEWS" />
...
## <img src="https://media.giphy.com/media/cj87CxfRtrUifF3Riz/giphy.gif" width="25"> What I Build

<table align="center">
<tr>
<td width="50%" valign="top">

### Solar Forecasting Platform
> Built for **Tata Power** solar assets across India
- Interactive Leaflet map with 7+ solar plant sites
- Physics-informed ML model for 3-day power predictions
- Real-time Grafana dashboards via TimescaleDB
- React 19 + FastAPI + Docker Compose stack
- V2 pipeline: Open-Meteo + NASA POWER data integration

</td>
<td width="50%" valign="top">

### Weather Prediction System
> Production ML pipeline at 15-min granularity
- XGBoost models for 5 weather variables across 10+ Indian locations
- 288-step forecasts (3 days ahead)
- PM2-managed scheduler with auto-recovery
- Leakage-free pipeline with validation tests
- PostgreSQL feature store + model registry
...
### MediVault
> AI-powered medical report manager
- OCR extraction with Tesseract
- LLM-powered summaries via Ollama/Mistral
- Semantic search using ChromaDB vector DB
- Family-based report organization
...
> Interactive deep learning demo platform
- Handwritten digit recognition (CNN, 98%+ acc)
- Image classification with MobileNetV2
- Sentiment analysis using LSTM
- Predictive analytics dashboard
- Flask + TensorFlow + vanilla JS frontend
